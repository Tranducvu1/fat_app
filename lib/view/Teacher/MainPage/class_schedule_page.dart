...
class ClassScheduleTeacherPage extends StatefulWidget {
  ...
  @override
  State<ClassScheduleTeacherPage> createState() =>
      _ClassScheduleTeacherPageState();
}

// State class name should match the widget
class _ClassScheduleTeacherPageState extends State<ClassScheduleTeacherPage> {
  String username = '';
